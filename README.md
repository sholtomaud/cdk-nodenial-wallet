...
**Pipeline Trigger:**
The pipeline is triggered by commits to the `main` branch (or as configured in `lib/pipeline-stack.ts`) of your GitHub repository.
...
2.  **Build:**
    ...
    *   Synthesizes the CDK application (`npx cdk synth`).
